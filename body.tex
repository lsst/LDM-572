...
The current Data Release 2\footnote{Data Release 2 is used as a reference because the compute and storage resources required to support it are covered by the MREFC construction budget.} The user computing resources at the US DAC are intended to comprise \citedsp{LDM-144}:
\begin{itemize}
...
The storage and other resources required to support the released data products is in addition to the user workspace resources described above in \secref{sec:hw}.
