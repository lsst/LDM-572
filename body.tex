...
We will need to work together to get the authentication system of the Chilean Grid integrated with the LSST system \citedsp{LSE-279} -- thus we should be able to authenticate users using Grid credentials, and furthermore we should be able to access Grid resources from the DAC using the same credentials.
This may be a heavy lift.
We have discussed with the Chile community creating individual accounts fo rusers agreed with the implementation comitee.
This may be simpler.

In anycase users will need a VPN to access the Chile DAC and part of the 2026 purchase was for VPN licenes for DAC users.
