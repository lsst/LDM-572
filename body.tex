...
The Data Release 2\footnote{Data Release 2 is used as a reference because the compute and storage resources required to support it are covered by the MREFC construction budget.} user computing resources at the US DAC are currently intended to comprise \citedsp{LDM-144}:
\begin{itemize}
